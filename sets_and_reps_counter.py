...
def create_parser():
    ...
    parser.add_argument('--rep_gap', type=int, required=True, help='The gap between reps in milliseconds.')
...
def create_combined_set_announcements(set_announcements: List[AudioSegment], combined_rep_announcements: AudioSegment) -> AudioSegment:
...
def create_combined_audio(args):
    ...
    combined_set_announcements = create_combined_set_announcements(set_announcements, combined_rep_announcements)
